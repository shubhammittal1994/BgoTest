...
public class TopGifterModel {
    ...
    public class Detail {
        ...
        public class UserInfo {
            ...
            public MoreDetail getMoredetails() {
                return moredetails;
            }

            public void setMoredetails(MoreDetail moredetails) {
            ...
            @Expose
            private MoreDetail moredetails;
            ...
            public class MoreDetail {
                ...
                @Expose
                private String frame_details;

                public String getFrame_details() {
                    return frame_details;
                }

                public void setFrame_details(String frame_details) {
                    this.frame_details = frame_details;
                }
            }
        }
    }
