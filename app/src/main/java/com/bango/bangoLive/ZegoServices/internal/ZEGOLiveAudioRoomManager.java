...
import com.bango.bangoLive.ZegoServices.internal.business.audioroom.LiveAudioRoomExtraInfo;
import com.bango.bangoLive.ZegoServices.internal.business.audioroom.LiveAudioRoomLayoutConfig;
import com.bango.bangoLive.ZegoServices.internal.business.audioroom.LiveAudioRoomSeat;
import com.bango.bangoLive.ZegoServices.internal.business.audioroom.RoomSeatService;
import com.bango.bangoLive.ZegoServices.internal.business.audioroom.RoomSeatServiceListener;
...
public class ZEGOLiveAudioRoomManager {
    ...
    public void init(LiveAudioRoomLayoutConfig layoutConfig) {
        ...
        audioRoomExtraInfo.setValuePairUpdateListener(new LiveAudioRoomExtraInfo.ValuePairUpdateListener() {
            @Override
