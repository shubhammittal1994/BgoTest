...
import com.bango.bangoLive.ZegoServices.ZEGOLiveAudioRoomManager;
import com.bango.bangoLive.ZegoServices.ZEGOSDKManager;
    ...
    public void onRoomAttributesUpdated(List<Map<String, String>> setProperties,
        ...
        for (Map<String, String> setProperty : setProperties) {
            for (Map.Entry<String, String> entry : setProperty.entrySet()) {
                ...
                LiveAudioRoomSeat seat = seatList.get(Integer.parseInt(key));
