package com.bango.bangoLive.ZegoServices.internal.sdk.express;
...
public class ExpressService {
    ...
    private List<IExpressEngineEventHandler> handlerList = new ArrayList<>();
    private List<IExpressEngineEventHandler> autoDeleteHandlerList = new ArrayList<>();
    ...
    public void logoutRoom(IZegoRoomLogoutCallback callback) {
        ...
        String currentRoomId = currentRoomID;
        removeRoomData();
        removeAutoDeleteRoomListeners();
        engineProxy.logoutRoom(currentRoomId, callback);
    }
