...
public class AdapterMyFrameEffect extends RecyclerView.Adapter<AdapterMyFrameEffect.Holder> {

private List<MyPuchageEffects.Detail> list;
        Context context;
        Callback callback;

public AdapterMyFrameEffect(List<MyPuchageEffects.Detail> list, Context context, Callback callback) {
        this.list = list;
...
public void onBindViewHolder(@NonNull Holder holder, @SuppressLint("RecyclerView") int position) {
        ...
        CommonUtils.setAnimation(context, list.get(position).getImage(), holder.frameImage);
...
public void loadData(List<MyPuchageEffects.Detail> ListData) {
        list = ListData;
...
public interface Callback {
    void TryFrame(MyPuchageEffects.Detail detail);

    void Frame(MyPuchageEffects.Detail detail, TextView buy);
}
}
